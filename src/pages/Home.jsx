...
export default function Home() {
  ...
  const handleQuickCheckout = async ({ type, amount, tier }) => {
    setCheckoutError(null);
    setCheckoutLoading(true);

    try {
      const transactionID = generateTransactionID('QCK');
            ...
            <div className="flex flex-col items-center justify-center px-4 max-w-7xl w-full my-auto">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10 sm:mb-12">
                <button
                  ...
                  onClick={() => handleQuickCheckout({ type: 'Vendor', amount: 250, tier: 'Standard' })}
                ...
                <button
                  type="button"
                  disabled={checkoutLoading}
                  onClick={() => handleQuickCheckout({ type: 'Vendor', amount: 500, tier: 'Flagship' })}
                ...
                <button
                  type="button"
                  disabled={checkoutLoading}
                  onClick={() => handleQuickCheckout({ type: 'Attendee', amount: 5, tier: 'Regular' })}
