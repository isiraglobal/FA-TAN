...
export default function Attendees() {
  ...
  const handleSubmit = async (e) => {
    ...
    const transactionID = generateTransactionID('TKT');
    ...
    try {
      ...
      await fetch(scriptURL, {
        ...
        mode: 'no-cors',
        body: JSON.stringify({ ...formData, type: 'Attendee', transactionID, amount, status: 'Pending', timestamp: new Date().toISOString() })
      });
