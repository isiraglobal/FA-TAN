...
export default function Attendees() {
  ...
  return (
    <div className="w-full min-h-screen pt-32 md:pt-40 px-6 md:px-12 flex flex-col items-center pb-20 md:pb-32 overflow-x-hidden">
      ...
      >
        <span className="text-[#0690d4] tracking-[0.4em] text-[10px] font-bold uppercase mb-4 opacity-80">Join the Experience</span>
        <h1 className="text-3xl md:text-7xl font-medium tracking-tight mb-6 md:mb-8 max-w-[90vw]">Fun, Value, Repeat</h1>
