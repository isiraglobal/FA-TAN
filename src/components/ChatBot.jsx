...
export default function ChatBot() {
  ...
  const handleSend = async () => {
    ...
    if (lowercaseInput.includes("booth") || lowercaseInput.includes("tier") || lowercaseInput.includes("standard") || lowercaseInput.includes("flagship")) {
      ...
      response = `Positioning analysis complete. Regarding "${input}", the MARKETPEACE infrastructure is optimized for high-fidelity deployment. We recommend syncing with our Strategic expansion protocols.`;
    }
