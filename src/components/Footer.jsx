      ...
      <div className="max-w-6xl w-full mx-auto px-6 mb-8 md:mb-12 flex flex-col items-center text-center relative z-20">
        ...
        <div className="flex flex-col items-center gap-8 md:gap-10 mb-12 md:mb-16">
          ...
          >
            ...
            <img src="/assets/logo.png" alt="MARKETPEACE Logo" className="w-16 h-16 md:w-24 md:h-24 object-contain relative z-10 mix-blend-multiply brightness-125" />
          </motion.div>
          ...
          <div className="flex gap-8 md:gap-10 mt-6 md:mt-8">
            <a href="https://instagram.com" target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#0077b6] transition-all text-[9px] md:text-xs tracking-[0.2em] font-black uppercase">Instagram</a>
            <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-white/40 hover:text-[#0077b6] transition-all text-[9px] md:text-xs tracking-[0.2em] font-black uppercase">Twitter</a>
